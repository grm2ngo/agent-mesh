...
copy /y "%~dp0..\templates\PROPOSALS.md" "%TARGET%\PROPOSALS.md"
copy /y "%~dp0..\templates\CRITIQUE.md" "%TARGET%\CRITIQUE.md"
copy /y "%~dp0..\templates\AUTHORIZATIONS.md" "%TARGET%\AUTHORIZATIONS.md"
copy /y "%~dp0..\docs\LESSONS.md" "%TARGET%\LESSONS.md"
